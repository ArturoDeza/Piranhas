function [clutter_scalar_fc, clutter_map_fc] = getClutter_FC_ROI(filename, limits, p);
...
clutter_map_fc = color_clutter{2}(y_lower:y_upper,x_lower:x_upper,:)/0.2088 + contrast_clutter{2}(y_lower:y_upper,x_lower:x_upper,:)/0.0660 + orient_clutter{2}(y_lower:y_upper,x_lower:x_upper)/0.0269;
